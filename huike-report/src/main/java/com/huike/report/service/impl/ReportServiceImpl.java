...
public class ReportServiceImpl implements IReportService {
    ...
    public IndexTodayInfoVO getTodayInfo() {
        ...
        String beginCreateTime = format;
        String endCreateTime = format;
        try {
            // 3 封装结果集对象
            result.setTodayCluesNum(reportMpper.getCluesNum(beginCreateTime, endCreateTime, username));
            result.setTodayBusinessNum(reportMpper.getBusinessNum(beginCreateTime, endCreateTime, username));
            result.setTodayContractNum(reportMpper.getContractNum(beginCreateTime, endCreateTime, username));
            result.setTodaySalesAmount(reportMpper.getSalesAmount(beginCreateTime, endCreateTime, username));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
